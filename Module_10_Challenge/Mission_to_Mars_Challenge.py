...
for elem in elem_list:
    ...
    # retrieve partial url from the soup object
    relative_url = img_soup.li.find('a').get('href')

    # retrieve full-res image URL string
    # build complete image url from partial url
    ...
    hemisheperes = {"img_url": img_url,
              "title": title}

    hemisphere_image_urls.append(hemisheperes)
    # use browser.back() to navigate back to the beginning
